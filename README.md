> Note: Credit where credit is due, this repo wasn't forked but it was a fork from [GitHub Stats Visualization](https://github.com/jstrieb/github-stats) because it was re-wriiten in zig  i wanted to experiment before deploying it and adding my need and what I think is right to do too, [jstrieb](github.com/jstrieb/) is an amazing developer definetly check him out
...
github-stats --access-token [YOUR_API_KEY] --json-output-file stats.json --debug
```
