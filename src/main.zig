...
const embedded_overview_output = ("output/overview.svg");
const embedded_languages_output = ("output/languages.svg");
...
pub fn main(init: std.process.Init) !void {
...

    {
        ...
        try writeFile(
            io,
            args.overview_output_file orelse embedded_overview_output,
            try overview(
                &arena,
                aggregate_stats,
        ...
        try writeFile(
            io,
            args.languages_output_file orelse embedded_languages_output,
            try languages(
                &arena,
                aggregate_stats,
